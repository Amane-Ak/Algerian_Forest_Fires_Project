...
# installed.
TCL_PREFIX='D:/Pregrad_Course/Aman_Algerian_Forest_Fire/Aman_ml_project\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Pregrad_Course/Aman_Algerian_Forest_Fire/Aman_ml_project\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Pregrad_Course/Aman_Algerian_Forest_Fire/Aman_ml_project\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Pregrad_Course/Aman_Algerian_Forest_Fire/Aman_ml_project\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Pregrad_Course/Aman_Algerian_Forest_Fire/Aman_ml_project\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Pregrad_Course/Aman_Algerian_Forest_Fire/Aman_ml_project\Library\lib\tclstub86.lib'
